...
require 'tataru/instructions/filter_instruction'
require 'tataru/instructions/check_exist_instruction'
require 'tataru/instructions/assert_instruction'
require 'tataru/instructions/invert_instruction'
require 'tataru/instructions/memwrite_instruction'
